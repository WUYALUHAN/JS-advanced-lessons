...
Object.defineProperties(obj,{
	y:{configurable:false,enumerable:false,writable:true,value:2},
   	z:{configurable:false,enumerable:true,writable:true,value:2} 
});//可以多个属性同时设置
console.log(obj.hasOwnProperty('y'),obj.hasOwnProperty('z'));
//true true   (与枚举无关)
...
console.log(o3.hasOwnProperty("x"),o3.hasOwnProperty("y"));//不关心可枚举 //true true
...
//o5 自有可遍历属性： c 234
// o5 非自有可遍历属性： a aaa
console.log(o5.propertyIsEnumerable("a"),//f
    o5.propertyIsEnumerable("b"),//f
    o5.propertyIsEnumerable("c"),//t
    o5.propertyIsEnumerable("d")//f
);//多少个true 多少个false
console.log("a" in o5,"b" in o5,"c" in o5,"d" in o5);//全是t
