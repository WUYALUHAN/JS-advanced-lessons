...
//回顾call()和apply() 在LS16/demo.js里
function a(x,y){
	console.log(x,y);
}
var arr=[1,2];
console.log(a.apply({},arr));// 1 2
//a.call({},arr[0],arr[1]);
console.log(a.call({},...arr));// 1 2
...
var student=(na,id)=>({name:na,Id:id});
student('Li',01);
//{name: "Li", Id: 1}
//等价于-->
var student=function(na,id){ return {name:na,Id:id}};
student('La',02);
//s{name: "La", Id: 2}
